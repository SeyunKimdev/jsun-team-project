...
<link rel="stylesheet" href="${pageContext.request.contextPath}/static/css/matching/sendMessagePage.css">
...
<script src="${pageContext.request.contextPath}/static/js/matching/sendMessagePage.js"> </script>
<script>
