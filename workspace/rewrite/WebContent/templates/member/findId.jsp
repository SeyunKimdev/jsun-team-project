...
<head>
	...
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/css/member/find.css" />
...
<body>
			...
			<div class ="findFormWrapper">
				<div class="findExpressContainer">
					<div class="findExpressWrapper">
						<h3 class="findExpressTitle">아이디를 잊으셨나요?</h3>
						<div class="spaceUnder"></div>
						<p class="findDetailExpress">계정에 연결된 전화번호를 입력하시면 확인 후 알려드립니다.</p>
					</div>
					<form style="width: auto; height: auto;">
						<div class="inputBoxContainer">
							<label>
								<div class="inputBoxWrapper">
									<input class="findFormInput" type="text" placeholder="전화번호를 입력해주세요">
								</div>
							</label>
    ...
    <script src="${pageContext.request.contextPath}/static/js/member/find.js"></script>
</html>