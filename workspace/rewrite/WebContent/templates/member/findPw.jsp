...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/static/css/member/find.css" />
<link rel="stylesheet" type="text/css"
...
<body>
															...
															<div class="mpDivDivDiv2">
																...
																<button class="mpDivDivDiv2Button">
																	<div class="mpDivDivDiv2ButtonDiv">
																		...
																		<span class="mpDivDivDiv2ButtonDivSpan2"> 마이페이지
																		</span>
																	</div>
																</button>
															</div>
	...
	<div class="findFormContainer">
		<div class="findFormWrapper">
			<div class="findExpressContainer">
				<div class="findExpressWrapper">
					<h3 class="findExpressTitle">비밀번호를 잊으셨나요?</h3>
					<div class="spaceUnder"></div>
					<p class="findDetailExpress">계정에 연결된 전화번호를 입력하시면 확인 후 창으로
						이동합니다.</p>
				</div>
				<form style="width: auto; height: auto;">
					<div class="inputBoxContainer">
						<div class="inputBoxWrapper">
							<input class="findFormInput" type="text"
		...
		<div class="inputNumberFormWrapper">
			<div class="inputNumberContainer">
				<div class="inputNumberWrapper">
					<h3 class="inputNumberTitle">인증번호 입력</h3>
					<div class="spaceUnder"></div>
					<p class="inputNumberText">인증번호를 전송했습니다.</p>
				</div>
				<form style="width: auto; height: auto;">
					<div class="inputBoxContainer">
						<label>
							<div class="inputBoxWrapper">
								<input class="numberInputBox" type="text"
					...
					<div class="footDivDiv2Div2Div1">
						<div class="footDivDiv2Div2Div1Div">
							...
							<a class="footDivDiv2Div2Div1DivA" href="" rel="noreferrer"><b>개인정보
								...
								rel="noreferrer">환불 정책</a> <a
								class="footDivDiv2Div2Div1DivA" href="" rel="noreferrer">사업자
								정보 확인</a> <a class="footDivDiv2Div2Div1DivA" href=""
								rel="noreferrer">단체/기업 교육 문의</a> <a
								class="footDivDiv2Div2Div1DivA" href="" rel="noreferrer">제휴/협력
								문의</a> <a class="footDivDiv2Div2Div1DivA" href="" rel="noreferrer">PR
								관련 문의</a> <a class="footDivDiv2Div2Div1DivA" href=""
								rel="noreferrer">지식재산권 침해 신고
								센터</a>
						</div>
					</div>
...
<script
	src="${pageContext.request.contextPath}/static/js/member/find.js"></script>
</html>