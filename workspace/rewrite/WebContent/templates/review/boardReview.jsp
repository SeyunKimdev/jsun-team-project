		...
		<div class="mainContainerDiv">
			<div class="mainContainerDivDiv">
				...
				<div top="0" right="0" bottom="0" left="0"
					class="review-avg-score-wrap">
					<!-- 점수주는 곳 -->
				</div>
				<!-- 리뷰 사진올리는 곳 -->
				<div class="review-whole-img">
					<!-- 리뷰 전체 사진 -->
				</div>
				...
				<div class="mainContainerDivDivDiv10">
					<div md="Body1" font-weight="bold" class="review_Whole">Review
						List</div>
				</div>
				<!-- 전체리뷰 아래 마진주는 용도 DIV -->
				<div top="0" right="0" bottom="24" left="0"
				...
				<div class="review-list-wrap">
					<ul smcolumn="1" class="review-list-ul">
						<!-- li 태그로 DB로 쏴줄 곳 -->
							...
							<div top="0" right="0" bottom="10" left="0"
								...
								<div top="0" right="0" bottom="0" left="0"
									...
									<div top="0" right="0" bottom="0" left="10"
										...
										<!-- 맴버 이름과 등록시간. -->
										<div md="Caption1" color="#a2a2a2" class="review_Member_Text">
											<p class="review_Member_Name">이름</p>
											<p class="review_Member_Date">등록 시간</p>
										</div>
									</div>
								</div>
							</div>
							<div md="Caption1" font-weight="600"
								class="review_Member_Profile_Title">RE Write 매칭 후기 - Title</div>
							<div md="Caption1" font-weight="600"
								class="mainContainerDivDivDiv12DivDivUlLiADiv3"></div>
							<div md="Body2" class="reveiw_Member_Profile_Content">처음에는
								막연하게 연해하고싶다라는 생각만 했었어요 하지만 이 사이트를 통해서 상대방의 장단점과 나에게 어떤 사람이 더 좋을지
								생각해볼 수 있는 계기가 되었습니다!! 피드 정리도 아주 깔끔하게 돼있어서 보기 너무 좋았어요 - Content</div>
							<div top="0" right="0" bottom="8" left="0"
								class="mainContainerDivDivDiv12DivDivUlLiADiv6"></div> <!-- 사진 올라가는 곳 -->
							<div class="review-member-img-wrap">
								<div class="review-img-wrap">
									<a class="review-member-img" href=""> <img
