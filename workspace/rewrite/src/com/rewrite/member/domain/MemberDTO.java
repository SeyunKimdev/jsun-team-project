...
public class MemberDTO {
	...
	public String toString() {
		return "MemberDTO [memberId=" + memberId + ", memberIdentification=" + memberIdentification
				...
				+ ", memberLikeCount=" + memberLikeCount + ", profileLocation=" + profileLocation + ", profileJob="
				+ profileJob + ", profileSalary=" + profileSalary + ", profileHobby=" + profileHobby + ", profileMbti="
				+ profileMbti + ", profileHeight=" + profileHeight + ", profileChild=" + profileChild
				+ ", profileMarried=" + profileMarried + ", fileOriginalName=" + fileOriginalName + ", fileSystemName="
