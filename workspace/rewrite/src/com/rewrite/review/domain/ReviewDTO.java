...
public class ReviewDTO {
	...
	public String toString() {
		return "ReviewDTO [reviewId=" + reviewId + ", reviewTitle=" + reviewTitle + ", reviewContent=" + reviewContent
				...
				+ ", reviewReadCount=" + reviewReadCount + ", reviewScore=" + reviewScore + ", memberNickname="
				+ memberNickname + ", memberId=" + memberId + ", fileId=" + fileId + ", fileOriginalName="
				+ fileOriginalName + ", fileSystemName=" + fileSystemName + ", fileRegisterDate=" + fileRegisterDate
				+ "]";
	}
